  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden px-4">
        ...
        {/* Floating orbs */}
        <div className="absolute top-1/4 left-1/4 w-32 sm:w-64 h-32 sm:h-64 bg-primary/10 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-48 sm:w-96 h-48 sm:h-96 bg-primary/5 rounded-full blur-3xl animate-float-slower" />
        
        {/* Content with glassmorphism */}
        <div className="container mx-auto text-center relative z-10">
          <div className="backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold mb-4 sm:mb-6 animate-fade-in text-primary">
              Welcome to Jungle Rent
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 max-w-2xl mx-auto animate-fade-in text-secondary/90">
      ...
      <section className="relative py-12 sm:py-20 px-4">
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {/* Investor Path */}
            <div className="backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl hover:shadow-primary/20 transition-all">
              <div className="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center text-primary mb-4">
                <DollarSign size={24} />
              </div>
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-primary">For Investors</h2>
            ...
            <div className="backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl hover:shadow-primary/20 transition-all">
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-primary">For Students</h2>
              <p className="text-secondary/80 mb-6">
            ...
            <div className="backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl hover:shadow-primary/20 transition-all">
              ...
              <h2 className="text-xl sm:text-2xl font-bold mb-4 text-primary">Short-term Stay</h2>
              <p className="text-secondary/80 mb-6">
      ...
      {/* How It Works */}
      <section className="relative py-12 sm:py-20 bg-gradient-to-b from-primary/20 via-primary-dark/10 to-background/90 px-4">
        <div className="container mx-auto text-center relative z-10">
          <div className="backdrop-blur-sm bg-white/5 p-6 sm:p-8 rounded-2xl border border-white/10 shadow-2xl">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-secondary">How Jungle Rent Works</h2>
