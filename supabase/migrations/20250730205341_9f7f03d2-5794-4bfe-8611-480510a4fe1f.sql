...
CREATE TYPE property_status AS ENUM ('available', 'occupied', 'maintenance', 'sold');
...
CREATE TABLE IF NOT EXISTS public.transactions (
  ...
  importo DECIMAL(12,2) NOT NULL,
  riferimento_id UUID, -- Can reference contracts, sfp_tokens, or properties
  riferimento_tipo TEXT, -- Type of the reference (contract, token, property)
  descrizione TEXT,
...
-- Update user roles to include new types
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'investor';
ALTER TYPE app_role ADD VALUE IF NOT EXISTS 'tourist';