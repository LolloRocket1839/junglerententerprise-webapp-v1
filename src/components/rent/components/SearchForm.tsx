...
export const SearchForm = ({
  ...
  return <main className="w-full">
      ...
      <section className="relative w-full flex items-center justify-center min-h-[400px] bg-gradient-to-b from-[#1a472a] to-[#2d5a3f]">
        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-0 mx-0">
          <div className="max-w-3xl mx-auto text-center space-y-8 py-16 px-0">
            ...
            <button onClick={handleSearch} className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-md transition-colors duration-300">
              Scopri di più
            </button>
          </div>
        </div>
