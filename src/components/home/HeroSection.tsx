  ...
  return <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-20" aria-label="Welcome section">
      ...
      <div className="container mx-auto text-center relative z-30">
        <GlassCard className="max-w-4xl mx-auto backdrop-blur-lg">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-wider mb-6 sm:mb-8 animate-fade-in 
                       bg-gradient-to-r from-primary-light via-primary to-primary-dark bg-clip-text text-transparent
                       drop-shadow-[0_2px_2px_rgba(0,0,0,0.3)] leading-tight font-sans">
