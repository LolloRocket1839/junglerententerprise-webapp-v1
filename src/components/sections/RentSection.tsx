...
import StudentBelongingsManager from '../student/StudentBelongingsManager';
    ...
    <div className="space-y-4">
      <Tabs defaultValue="search" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-4">
          <TabsTrigger value="search">Cerca Alloggio</TabsTrigger>
          <TabsTrigger value="belongings">I Tuoi Averi</TabsTrigger>
        </TabsList>
